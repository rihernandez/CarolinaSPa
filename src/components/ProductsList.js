                        ...
                        <tbody>
                            {
                                this.state.productos.map(producto => (
                                    ...
                                    onDoubleClick={() =>{this.deleteProduct(producto.id_Producto)}}
                                    >
                                        ...
                                        <td>
                                            <Link className="btn btn-sm btn-primary" to={"/edit/" + producto.id_Producto}>
                                                Editar
                                            </Link>
                                        </td>
                                        <td>
                                            <button className="btn btn-sm btn-danger" onClick={() => {this.deleteProduct(producto.id_Producto)}}>
                                                Borrar
                                            </button>
                                        </td>
