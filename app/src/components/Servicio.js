...
export default class Servicio extends Component {
    ...
    render() {
        return ( <
            ...
            <
            Link className = "btn btn-primary col-3 m-1"
            to = "/createserv" >
            Añadir servicio { " " } <
            /Link>{" "} <
            ...
            tr >
            <
            th scope = "col" > Id < /th> <th scope="col"> Servicio </th > { " " } <
            th scope = "col" > Descripcion < /th> <th scope="col"> Precio </th > { " " } <
            /tr>{" "} <
            /thead>{" "} {
                this.state.servicios.map((servicio) => ( <
                    ...
                    td > { servicio.servicio } < /td> <td> {servicio.descripcion} </td > { " " } <
                    td > { servicio.precio } < /td>{" "} <
                    td >
                    <
                    Link className = "btn btn-info"
                    to = { "/editserv/" + servicio.id_servicio } >
                    Editar { " " } <
                    /Link>{" "} <
                    /td>{" "} <
                    td >
                    ...
                    onClick = {
                        () => this.deleteServicio(servicio.id_servicio) } >
                    Eliminar { " " } <
                    /button>{" "} <
                    /td>{" "} <
                    /tbody>
