...
class CreateProducto extends Component{
    ...
    async componentDidMount(){
        ...
        if (this.props.match.params.id) {
            ...
            this.setState({
                ...
                cantidad: res.data.existencia,
                cantidadMax: res.data.existenciaMax,
                cantidadMin: res.data.existenciaMin,
                ultimaVenta: new Date(res.data.ultimaVenta),
                ultimaEntrada: new Date(res.data.ultimaEntrada),
                editing: true,
    ...
    getResult = async () =>{
           ...
           this.setState({
               ...
               categorias: cat.data,
               id_proveedor: prov.data[0].id_Proveedor,
               id_categoria: cat.data[0].id_Categoria,
               estado: 0
           });
    ...
    onSubmit = async (e) => {
        ...
        if (this.state.editing) {
            await axios.put('http://localhost:8990/api/producto/' + this.state.id_Producto, newProducto);
                ...
                <div className="col-md-8 mx-auto">
                    <div className="card card-body">
                        ...
                        <form onSubmit={this.onSubmit}>
                            ...
                            <div className="form-group">
                                <label className="text-muted">Ultima Venta *</label>
                                <br/>
                                <DatePicker
                                    className="form-control"
                            ...
                            <div className="form-group">
                                <label className="text-muted">Ultima Entrada *</label>
                                <br/>
                                <DatePicker
                                    className="form-control"
